...
const FName AAIWheeledVehicle::EngineAudioRPM("RPM");

AAIWheeledVehicle::AAIWheeledVehicle(const FObjectInitializer& ObjectInitializer)
...
void AAIWheeledVehicle::UpdatePhysicsMaterial()
{
